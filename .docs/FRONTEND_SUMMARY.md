...
### 3. 🔍 Grad-CAM Heatmap Visualization
...
- **Color-coded grades**: Each grade has distinct gradient colors
  - Grade 0: Green gradient (✅)
  - Grade 1: Orange-pink gradient (⚠️)
  - Grade 2: Orange-yellow gradient (🔶)
  - Grade 3: Red-orange gradient (🔴)
  - Grade 4: Red gradient (🚨)
